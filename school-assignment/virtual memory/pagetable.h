...
typedef struct { 
	unsigned int frame; // if valid bit == 1, physical frame holding vpage, this is the entry shown in the handout
...
struct frame {
	...
	// LRU: most recently use page towards the head, least recently use page towards the back
